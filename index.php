...
<html lang="en">
<head>
    <meta charset="UTF-8"> <!--This is used to describe the character in coding of a website-->
    <meta name="viewport" content="width=device-width, initial-scale=1.0"> <!--This tells the mobile phones to not zoom out of the page and should always start with a scale of 1-->
    ...
    <!-- <meta name="viewport" content="width=device-width, initial-scale=1.0">  THIS CAME WITH ! tab-->
...
<body>
    <header id="top">
            <nav>
                <div class="row">
                    <img src="Omnifood+Content/logo-white.png" alt="Omnifood logo" class="logo">
                    <a href="#top"><img src="Omnifood+Content/logo.png" alt="Omnifood logo" class="logo-black"></a>
    ...
    <section class="section-features js--section-features" id="features">
        <div class="row">
            ...
            <p class="long-copy">
                Hello, we're Omnifood, your new premium delivery service. We know you're always busy. No time for cooking. So let us take care of that, we're really good at it, we promise!
            </p>
        </div>
        <div class="row js--wp-1">
            <div class="col span-1-of-4 box">
                <i class="ion-ios-infinite-outline icon-big"></i>
                <h3>Up 365 days/year</h3>
                <p>
            ...
            <div class="col span-1-of-4 box">
                ...
                <p>We don't limit your creativity, which means you can order what ever you feel like. You can also choose from our menu containing over 100 delicious meals. It's up to you!</p>
            </div>
        </div>
    </section>
    ...
    <section class="section-meals">
        <ul class="meals-showcase clearfix">
            ...
            <li>
                <figure class="meal-photo">
                    <img src="resources/img/4.jpg" alt="Autum pumpkin soup">
                </figure>
            </li>
        </ul>
        <ul class="meals-showcase clearfix">
        ...
        <div class="row" >
            <form method="post" action="mailer.php" class="contact-form">
                <div class="row">
                    <?php
                    if ($_GET['success'] == 1) {
                        echo "<div class=\"form-messages success\">Thank you! Your message has been.</div>";
                    }
                    if ($_GET['success'] == -1) {
